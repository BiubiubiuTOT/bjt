 ...
 */
public class WorkDayAdapter extends RecyclerView.Adapter<WorkDayAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public WorkDayAdapter(List<String> lists, Context context) {
        this.lists = lists;
