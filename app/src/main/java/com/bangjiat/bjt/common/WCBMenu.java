...
public class WCBMenu {
    ...
    private List<WcbBean> mStringList = new ArrayList<>();
    ...
    public WCBMenu setStringList(List<WcbBean> list) {
        mStringList.clear();
    ...
    private class Builder {
        ...
        private Builder() {
            popupView = LayoutInflater.from(mContext).inflate(R.layout.layout_web_menu, null);
    ...
    private class MenuListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            WcbBean wcbBean = mStringList.get(position);
            viewHolder.mTextView.setText(wcbBean.getName());
            int corlor = wcbBean.getCorlor();
            if (corlor != 0) {
                viewHolder.mTextView.setTextColor(corlor);
            }
            viewHolder.mTextView.setTextSize(17);
